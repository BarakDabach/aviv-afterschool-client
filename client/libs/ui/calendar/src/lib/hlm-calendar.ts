    ...
    <div class="inline-flex flex-col gap-4">
      ...
      <div class="flex w-full items-center justify-between gap-1.5">
        ...
        <button
          ...
          variant="ghost"
          hlmBtn
          class="order-first size-(--cell-size) !rounded-[8px] p-0 select-none aria-disabled:opacity-50"
        >
        ...
        <button
          ...
          hlmBtn
          variant="ghost"
          class="order-last size-(--cell-size) !rounded-[8px] p-0 select-none aria-disabled:opacity-50"
        >
...
export class HlmCalendar<T> {
  ...
  protected readonly _selectClass = 'gap-0 !rounded-[6px] px-1.5 py-2 [&>ng-icon]:ms-1';

  constructor() {
    classes(
      () =>
        'p-3 [--cell-radius:8px] [--cell-size:--spacing(8)] group/calendar bg-background block in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
    );
  }
}
